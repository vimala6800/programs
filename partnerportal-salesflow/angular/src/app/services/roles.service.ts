...
export class RolesService {
  ...
  getUser(id: string): Observable<any[]> {
    return this.http.get<any[]>(this.baseApiUrl + '/api/Profile/' + id);
  }
  getFunctionality(id: string): Observable<any[]> {
    return this.http.get<any[]>(this.baseApiUrl + '/api/Functionality/' + id);
  }
  updateUser(updateEmployeeRequest: any, id: string): Observable<any> {
    console.log(updateEmployeeRequest);
    return this.http.put<any>(this.baseApiUrl + '/api/Profile/' + id, updateEmployeeRequest);
  }
