...
export class RegisterService {
  ...
  getAllPartners(): Observable<User[]> {
    return this.http.get<User[]>(this.base_url + '/api/User/GetAllUser');
  }
  addUsers(addUsersReqest: any): Observable<any> {
    //addUsersReq.role = '';
    return this.http.post<any>(this.base_url + '/api/Users/', addUsersReqest);
  }
